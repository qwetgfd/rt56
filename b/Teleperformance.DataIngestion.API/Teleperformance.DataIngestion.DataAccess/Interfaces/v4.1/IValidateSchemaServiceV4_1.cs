...
{
    public interface IValidateSchemaServiceV4_1
    {
        Task<Dictionary<string, FlpFileColumnMappingDto>> ValidateFileSchema(
   string flpConfigurationId, bool validateFileSchema, bool isHeaderProvided, List<string> fileHeaders, string processName,string tabName, string tableName, IEnumerable<FlpFileColumnMappingDto> columnList = null);
