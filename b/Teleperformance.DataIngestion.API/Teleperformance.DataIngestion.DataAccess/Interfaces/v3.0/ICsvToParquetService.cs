...
{
    public interface ICsvToParquetService
    {
        Task<ParquetFileResponseDto> ConvertDataToParquetExcel(ConfigurationTableMappingDto configurationTableMappingDto, FlpConfigurationResponseDto parameterConfig, FlpProcessTempFile fileProcessingConfig);
