...
{
    public class TxtToParquetServiceV4 : ITextToParquetServiceV4
    {
        private readonly ILogger<TxtToParquetServiceV4> _logger;
        ...
        public TxtToParquetServiceV4(
           ILogger<TxtToParquetServiceV4> logger, ISMBLibraryServices ismbLibraryServices, IProcessConfigurationRepository iIProcessConfigurationRepository, ICache cache, IValidateSchemaService iValidateSchemaService, IFlpProcessingService iIFileProcessingService, IProcessConfigServiceV3 processConfigurationService,IProcessConfigurationRepositoryV4_1 processConfigurationRepositoryV4_1)
        {
            _logger = logger;
            ...
            _iProcessConfigurationService = processConfigurationService;
