...
{
    public class ValidateSchemaServiceV4_1 : IValidateSchemaServiceV4_1
    {
        ...
        public ValidateSchemaServiceV4_1(IValidateSchemaRepository validateSchemaRepository, ILogger<ValidateSchemaService> logger)
        {
        ...
        public async Task<Dictionary<string, FlpFileColumnMappingDto>> ValidateFileSchema(
         string flpConfigurationId, bool validateFileSchema, bool isHeaderProvided, List<string> fileHeaders, string processName,string tabName, string tableName, IEnumerable<FlpFileColumnMappingDto> fileMappingColumnList = null)
        {
            ...
            if (fileMappingColumnList == null)
                fileMappingColumnList = await GetFileColumnListV2ByTabName(flpConfigurationId,tabName);
            ...
            foreach (var fileHeader in fileHeaders)
            {
                ...
                else
                {
                    ...
                    if (!validateFileSchema)
                    {
                        ...
                        await _validateSchemaRepository.AddNewColumnMapping(flpConfigurationId, processName, tableName, fileHeader.ToUpper(), fileHeader.ToUpper(),"string", (int)DatatypeNamesEnum.STRING, tabName);
            ...
            if (!validateFileSchema)
            {
                ...
                foreach (var keyValuePair in customHeadersColumnsMapping)
                {
                    ...
                    if (dictValues)
                    {
                        ...
                        //TODO:need to update this addionally column in the database
                        await _validateSchemaRepository.AddNewColumnMapping(flpConfigurationId, processName, tableName, keyValuePair.Key.ToUpper(), fileColumns[index].ToUpper(),"string", (int)DatatypeNamesEnum.STRING,tabName);
