            ...
            try
            {
                ...
                if (isCopiedFile && flpProcessTempFile != null)
                {
                    ...
                    if (flpProcessTempFile != null)
                    {
                        ...
                        {
                            #region SharePoint Workspace - AY
                            _logger.LogInformation("Moving SharePoint file to Processed folder for {FlpConfigurationId}, file {FileLocation}",
                            ...
                            try
                            {
                                ...
                                {
                                    ApplicationId = flpConfigurationRequestDto.SharePointApplicationId ?? Guid.Empty,
                                ...
                                else
                                {
                                    ...
                                    _logger.LogError("Failed to move SharePoint file to Processed folder for {FlpConfigurationId}", flpConfigurationRequestDto.FlpConfigurationId);
                                }
                            }
                            catch (Exception ex)
                            {
